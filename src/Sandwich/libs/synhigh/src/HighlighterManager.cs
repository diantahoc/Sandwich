...
namespace AurelienRibon.Ui.SyntaxHighlightBox {
	public class HighlighterManager {
		...
		private HighlighterManager() {
			...
			var gfdgd = Application.GetResourceStream(new Uri("pack://application:,,,/Sandwich;component/Resources/shls/syntax.xsd"));
			...
			foreach (var res in GetResources("resources/shls/(.+?)[.]xml")) {
